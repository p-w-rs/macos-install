...
brew install amp atomicparsley wget tree htop fswatch duti python-yq pandoc mas cfonts yt-dlp qrencode unison
...
brew install --cask adobe-digital-editions combine-pdfs ghostty nikitabobko/tap/aerospace typora xquartz
